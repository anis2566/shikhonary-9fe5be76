...
import { Plus, Building2, Mail, CreditCard, Settings2 } from "lucide-react";
...
interface CreateTenantDialogProps {
  onTenantCreated?: (tenant: TenantFormValues) => void;
}
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-display">Create New Tenant</DialogTitle>
        </DialogHeader>
