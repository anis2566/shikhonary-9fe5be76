...
import { Search, CircleHelp, Filter, FileQuestion, Eye } from 'lucide-react';
...
const QuestionBankPage: React.FC = () => {
  ...
  }, [mcqSearch, mcqFilterSubject, mcqFilterType, mcqFilterChapter]);
  ...
  }, [cqSearch, cqFilterSubject, cqFilterChapter]);
          ...
          <TabsContent value="mcqs" className="mt-6 space-y-6">
            ...
            {paginatedMcqs.length === 0 ? (
              <div className="bg-card rounded-xl border border-border p-8 text-center">
                ...
                <p className="text-muted-foreground">No MCQs found matching your criteria</p>
              </div>
            ) : (
          ...
          <TabsContent value="cqs" className="mt-6 space-y-6">
            ...
            {paginatedCqs.length === 0 ? (
              <div className="bg-card rounded-xl border border-border p-8 text-center">
                ...
                <p className="text-muted-foreground">No CQs found matching your criteria</p>
              </div>
            ) : (
